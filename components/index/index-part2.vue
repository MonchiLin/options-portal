...
export default defineComponent({
  ...
  setup() {
    ...
    const text = reactive({
      ...
      t2: "What We Offer",
      t3: "The financial goal of every individual is different. AtSteadyoption, we conduct thorough research to zero inon the right mutual fund scheme for you. Steady’s fundrecommendations are based on an in-depth analysis ofvarious categories of equity and debt mutual fund schemes.",
      t4: [
        "The right choice for 170,000+ worldwide",
        "Cumulative user revenue has reached 1.7 billion rupees",
        "Starting at Rs 1,000",
        "The income is settled to the account daily",
        "Annualized income is as high as 132%+",
      ],
      t5: "Invest now",
      t6: "Learn more"
    })
