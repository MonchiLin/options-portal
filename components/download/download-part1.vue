<template>
  <the-part
      background-for-md="/download/part1/bg_m.jpg"
      background="/download/part1/bg.png"
  >
    <div
        class="
          <md:(h-[837px] w-full flex-col-reverse)
          h-[600px] flex-row
          page-content flex items-center text-white justify-center
        "
    >
